...
import { WEB_ORIGIN } from '../lib/deployment';
...
function getSafeReturnTo(value: unknown): string {
  // In split-origin deployments the fallback is the configured frontend
  ...
  if (WEB_ORIGIN) {
    try {
      if (new URL(value).origin === WEB_ORIGIN) return value;
    } catch {
